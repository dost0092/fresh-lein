      ...
      {rows.map((row) => (
        <div
          ...
          className={cn(
            ...
            'hover:bg-neutral-50 border-l-2 border-l-transparent hover:border-l-primary'
          )}
        ...
        >
          ...
          <span className="shrink-0 flex items-center text-xs font-medium text-primary group-hover:text-primary/80">
